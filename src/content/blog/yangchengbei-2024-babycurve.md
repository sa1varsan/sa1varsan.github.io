---
title: '羊城杯 2024 - BabyCurve'
description: '先从公开点反推出曲线参数，再处理曲线离散对数与 AES 密钥恢复。'
timeLabel: 2024
timeOrder: 2024
...
找到曲线了。开做。有点小问题，不过问题不大。

```
n0 = 826100030683245480440340333294
```

阶是这个，不是很光滑

不是，G,P两点已知，可以直接算出来参数b,c啊！这出题人出了个寂寞啊。
